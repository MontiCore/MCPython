...
import enum
__all__ = ('Labwares', 'Tip', 'int_to_tip')
...
def int_to_tip(tip_int):
    ...
    if tip_int == 1:
        ...
        return Tip.T8
    raise ValueError(f'Tip is {tip_int} with type {type(tip_int)}, but should be an int between 1 and 8 for _int_to_tip conversion.')